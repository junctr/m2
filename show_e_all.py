...
e_all_p = np.loadtxt(dir_base0 + f"s{n_seed}_m{alpha_lambda0}_wn{alpha_wn0}_{alpha_wn1}_s{alpha_0s0}_{alpha_0s1}_{alpha_0s2}_T{T}_step{step}_t{end}_e_all.csv",delimiter = ",")
# e_all_c = np.loadtxt(dir_base1 + f"s{n_seed}_m{alpha_lambda1}_wn{alpha_wn0}_{alpha_wn1}_s{alpha_1s0}_{alpha_1s1}_{alpha_1s2}_T{T}_step{step}_t{end}_e_all.csv",delimiter = ",")
